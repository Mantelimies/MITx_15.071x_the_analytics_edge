...
library(ggplot2)
ggplot(data = CocaCola, aes(x = Date, y = StockPrice)) + geom_line(data = CocaCola[301:432,], aes (colour = "CocaCola")) + geom_line(data = ProcterGamble[301:432,], aes (colour = "ProcterGamble")) + geom_line(data = GE[301:432,], aes (colour = "GE")) + geom_line(data = IBM[301:432,], aes (colour = "IBM")) + geom_line(data = Boeing[301:432,], aes (colour = "Boeing")) + scale_color_manual("",breaks = c("CocaCola","ProcterGamble","GE","IBM","Boeing"), values = c("blue", "red","green","skyblue","tan")) + geom_vline(xintercept = as.numeric(as.Date("1997-10-01")))
```
