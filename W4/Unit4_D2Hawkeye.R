...
head(ClaimsTrain)
nrow(ClaimsTrain[which(ClaimsTrain$diabetes == 1),])/nrow(ClaimsTrain)
# VIDEO 7
...
sum(table(ClaimsTest$bucket2009, PredictTest1)[,1])
table(PredictTest1)
...
sum(table(ClaimsTest$bucket2009, PredictTest2))
table(PredictTest2)
